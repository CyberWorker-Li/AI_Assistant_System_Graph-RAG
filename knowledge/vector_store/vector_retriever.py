    ...
    def __init__(self, indexer: SimpleVectorIndexer, reranker_model_name: str = "BAAI/bge-reranker-base", enable_rerank: bool = True, local_files_only: bool = False):
        ...
        if enable_rerank:
            try:
                ...
                # 直接使用用户提供的本地路径
                local_reranker_path = "D:\\mine\\bjtu\\AI_Assistant_Model\\graph_maker_LLM\\AI_Assistant\\models\\bge-reranker-base"
                self._reranker = CrossEncoder(local_reranker_path, max_length=512)
